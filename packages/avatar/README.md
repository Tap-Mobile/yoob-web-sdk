...
With `YoobConversation`, microphone audio goes directly from the browser to OpenAI; with `YoobGeminiConversation`,
directly to Google.

## Content Security Policy

Allow `connect-src https://cdn.yoob.com https://api.yoob.com` (plus `wss://api.openai.com` or
`wss://generativelanguage.googleapis.com` for conversations),
